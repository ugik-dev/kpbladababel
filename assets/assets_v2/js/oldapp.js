...
!(function (e) {
		...
		!(function () {
			...
			function E(e, t) {
				e.canvasRemoved ||
					!e.set ||
					e.paused ||
					(d(t) && t.call(e, "pause"), (e.paused = !0));
			}
			function _(e, t) {
				!e.canvasRemoved &&
					e.set &&
					e.paused &&
					(d(t) && t.call(e, "open"), (e.paused = !1), e.draw());
			}
			function S(e, t) {
				e.set.resize &&
			...
			var A = (function () {
				...
				R = 485,
				H = 300,
				j = { trimAll: /\s/g, styleValue: /^\d+(\.\d+)?[a-z]+$/i },
				M = (function () {
					function e(t, n, i) {
						(function (e, t) {
							if (!(e instanceof t))
							...
							x &&
								(this.container = m(n) ? n : I.querySelector(n)) &&
								((this.set = c(!0, {}, B.commonConfig, t.defaultConfig, i)),
						...
						A(e, [
							{
								...
								value: function () {
									this.canvasRemoved ||
										this.paused ||
										O.requestAnimationFrame(this.draw.bind(this));
								},
							},
							{
			...
			var $ = (function () {
					...
					return e
						...
						: function (e, n) {
								var i = function i(o) {
									t(o.target, e) &&
										(document.removeEventListener("DOMNodeRemoved", i), n());
								};
				...
				B = { version: "2.0.1", utils: F, Base: M, easing: W };
			!(function e(t) {
				for (var n in t) {
					var i = t[n];
					C(i, n, t), f(i) && e(i);
				...
				(B.commonConfig = { opacity: 1, color: [], resize: !0 }),
				(O.JParticles = B),
				void 0 ===
					(i = function () {
						return B;
						...
						function n(e, t) {
							return (
								...
								(function (e, t) {
									...
									this,
									(n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, t)
								)
							);
						}
						return (
								...
								},
								{
									...
									value: function () {
										...
										e.forEach(function (o, r) {
											for (
												var s = o.x + o.parallaxOffsetX,
													a = o.y + o.parallaxOffsetY,
													l = function () {
														var i = e[r],
										...
										this.dots.forEach(function (r) {
											if (!e) {
												if (a) {
													...
													(r.parallaxOffsetX +=
														(t / c - r.parallaxOffsetX) / 10),
														(r.parallaxOffsetY +=
															(n / c - r.parallaxOffsetY) / 10);
												}
												(r.x += r.vx), (r.y += r.vy);
												var u = r.x,
													d = r.y,
								...
								},
								{
									...
									value: function () {
										return (this.elemOffset =
											this.set.eventElem === document
												? null
												: m(this.set.eventElem));
									},
								},
								{
									key: "proxyEvent",
											...
											this.dots.forEach(function (s, l, c) {
												...
												t.save(),
													...
													o ||
														...
														r() > 0.99 && r() > 0.5 && (s.vx *= -1),
														u < 0 || u - f > n
															? c.splice(l, 1, e.snowShape())
															: d - f > i && c.splice(l, 1));
											}),
											!o && r() > 0.9 && this.createDots(),
											this.requestAnimationFrame();
									},
								},
							]),
							...
							e(n, [
								...
								},
								{
									...
									value: function (e) {
										...
										for (f(n) || (i = this.set[e] = []); t--; ) {
											var r = f(n) ? n[t] : n;
											(i[t] = h(r)
												? this.generateDefaultValue(e)
												: this.scaleValue(e, r, o)),
												"rippleNum" === e &&
													(this.rippleLength[t] = this.cw / i[t]);
										}
									},
								},
								{
								...
								},
								{
									...
									value: function (e) {
										if (this.set && p(e))
											for (var t in e)
												"opacity" === t
													? (this.set.opacity = e[t])
													: -1 !== this.dynamicOptions.indexOf(t) &&
													  this.dynamicProcessor(t, e[t]);
									},
								},
								{
									key: "createDots",
								...
								},
								{
									...
									value: function () {
										var e = this;
										m(this, function (t, n) {
											["offsetLeft", "offsetTop", "crestHeight"].forEach(
												function (i) {
						...
						return (
							...
							e(n, [
									...
									value: function () {
										if (this.immediatelyComplete)
											return (
												...
												void (this.immediatelyComplete += 0.5)
											);
										if (!(this.progress >= 99)) {
											var e = this.set,
												t = e.easing,
											...
											var i = Date.now() - this.startTime,
												o = i / n;
											o <= 1 &&
												((this.progress = JParticles.easing[t](
													o,
													i,
													0,
													100,
								...
								},
								{
									key: "calcOffsetTop",
									value: function () {
										(this.immediatelyComplete || 99 !== this.progress) &&
											(100 === this.progress
												? (this.set.offsetTop = -this.set.crestHeight)
												: (this.set.offsetTop = a(
														((100 - this.progress) / 100) * this.ch +
															this.set.crestHeight
												  )));
									},
								},
								{
								...
								},
								{
									...
									value: function () {
										return h.apply(
											void 0,
											[this, this.progressListeners].concat(
												Array.prototype.slice.call(arguments)
											)
										);
									},
								},
								{
									...
									value: function () {
										return h.apply(
											void 0,
											[this, this.finishedListeners].concat(
												Array.prototype.slice.call(arguments)
											)
										);
									},
						...
						modifiers: {
							...
							arrow: {
								...
								fn: function (e, t) {
									...
									return (
										(T = Math.max(Math.min(s[u] - m, T), 0)),
										(e.arrowElement = i),
										(e.offsets.arrow =
											(_((n = {}), f, Math.round(T)), _(n, p, ""), n)),
										e
									);
								},
								element: "[x-arrow]",
	...
	EVdn: function (e, t, n) {
		...
		!(function (t, n) {
			...
			var r = [],
				...
				T = { type: !0, src: !0, noModule: !0 };
			function w(e, t, n) {
				var i,
					o = (t = t || s).createElement("script");
				if (((o.text = e), n)) for (i in T) n[i] && (o[i] = n[i]);
					...
					function (e, t) {
						_.fn[e] = function (n, i) {
							...
							return (
								...
								this.length > 1 &&
									(H[e] || _.uniqueSort(o), R.test(e) && o.reverse()),
								this.pushStack(o)
							);
						};
					}
			...
			function we(e, t, n, i, o) {
				...
				for (d.textContent = "", p = 0; (r = f[p++]); )
					if (i && _.inArray(r, i) > -1) o && o.push(r);
						...
						((c = _.contains(r.ownerDocument, r)),
			...
			function je(e, t) {
				...
				if (1 === t.nodeType) {
					...
					Z.hasData(e) &&
						((a = Z.access(e)), (l = _.extend({}, a)), Z.set(t, l));
				}
			}
			function Me(e, t, n, i) {
				t = c.apply([], t);
				...
				if (
					...
					for (a = (s = _.map(ge(o, "script"), Re)).length; d < f; d++)
						(l = o),
							d !== p &&
								((l = _.clone(l, !0, !0)), a && _.merge(s, ge(l, "script"))),
							n.call(e[d], l, d);
					if (a)
						for (
							u = s[s.length - 1].ownerDocument, _.map(s, He), d = 0;
							d < a;
							d++
						)
							(l = s[d]),
								he.test(l.type || "") &&
									...
									(l.src && "module" !== (l.type || "").toLowerCase()
										? _._evalUrl && _._evalUrl(l.src)
										: w(l.textContent.replace(Le, ""), u, l));
				}
				return e;
			}
			function $e(e, t, n) {
				for (var i, o = t ? _.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
					n || 1 !== i.nodeType || _.cleanData(ge(i)),
						i.parentNode &&
							(n && _.contains(i.ownerDocument, i) && ve(ge(i, "script")),
			...
			function Ze(e, t, n, i, o, r) {
				...
				for (; s < 4; s += 2)
					"margin" === n && (l += _.css(e, n + re[s], !0, o)),
						i
							? ("content" === n && (l -= _.css(e, "padding" + re[s], !0, o)),
							  "margin" !== n &&
									(l -= _.css(e, "border" + re[s] + "Width", !0, o)))
							: ((l += _.css(e, "padding" + re[s], !0, o)),
							  "padding" !== n
									? (l += _.css(e, "border" + re[s] + "Width", !0, o))
									: (a += _.css(e, "border" + re[s] + "Width", !0, o)));
				return (
					!i &&
						r >= 0 &&
						(l += Math.max(
			...
			_.extend(_.event, {
				trigger: function (e, t, i, o) {
					...
					if (
						...
						if (!o && !f.noBubble && !b(i)) {
							for (
								c = f.delegateType || g, bt.test(c + g) || (a = a.parentNode);
								a;
								a = a.parentNode
							)
								m.push(a), (l = a);
								...
								c
									? (h.ifModified &&
									  ...
									  204 === e || "HEAD" === h.type
											...
											: 304 === e
											? (E = "notmodified")
											: ((E = T.state), (f = T.data), (c = !(p = T.error))))
			...
			_.ajaxSetup({
				...
				_.each(["top", "left"], function (e, t) {
					_.cssHooks[t] = qe(v.pixelPosition, function (e, n) {
						if (n)
							return (n = Ue(e, t)), Fe.test(n) ? _(e).position()[t] + "px" : n;
					});
				}),
			...
			return (
				(_.noConflict = function (e) {
					return (
						n.$ === _ && (n.$ = Gt), e && n.jQuery === _ && (n.jQuery = Xt), _
					);
				}),
				o || (n.jQuery = n.$ = _),
				_
	...
	"N/WM": function (e, t, n) {
		...
		(s = function (e) {
			...
			function n(e, t, n) {
				...
				for (
					var s, a, l = /uniform (\w+) (\w+)/g, c = e + t;
					null != (s = l.exec(c));

				)
					(a = s[2]), (o.locations[a] = r.getUniformLocation(o.id, a));
				return o;
			}
			function i(e, t) {
			...
			var r,
				s = (e = e && "default" in e ? e.default : e)(window),
				l = (function () {
					function e(e, t, i) {
						...
						return (
							s && a.push(r),
							{ type: t, arrayType: i, linearSupport: s, extensions: a }
						);
					}
					...
					i.push(e("float", r.FLOAT, Float32Array)),
						n.OES_texture_half_float &&
							i.push(
								e("half_float", n.OES_texture_half_float.HALF_FLOAT_OES, null)
							);
			...
			var u = function (t, n) {
				...
				for (
					var s = l.arrayType,
						a = s ? new s(this.resolution * this.resolution * 4) : null,
						c = 0;
					c < 2;
					c++
				) {
					...
					r.bindFramebuffer(r.FRAMEBUFFER, d),
						...
						r.texParameteri(
							...
							l.linearSupport ? r.LINEAR : r.NEAREST
						),
						r.texParameteri(
							r.TEXTURE_2D,
				...
				(u.prototype = {
					setupPointerEvents: function () {
						...
						this.$el
							...
							.on("touchmove.ripples, touchstart.ripples", function (t) {
								for (
									var n = t.originalEvent.changedTouches, i = 0;
									i < n.length;
									i++
								)
									e(n[i]);
						...
						if (t != this.imageSource)
							if (((this.imageSource = t), this.imageSource)) {
								...
								(n.onload = function () {
									...
									r = e.context;
									var i =
										t(n.width) && t(n.height) ? r.REPEAT : r.CLAMP_TO_EDGE;
					...
					computeTextureBoundaries: function () {
						...
						var c = o[0],
							u = o[1];
						(c = t(c)
							? e.left + ((e.width - a) * parseFloat(c)) / 100
							: e.left + parseFloat(c)),
							(u = t(u)
								? e.top + ((e.height - l) * parseFloat(u)) / 100
								: e.top + parseFloat(u));
						...
						(this.renderProgram.uniforms.topLeft = new Float32Array([
							...
							(this.renderProgram.uniforms.bottomRight = new Float32Array([
								this.renderProgram.uniforms.topLeft[0] +
									this.$el.innerWidth() / a,
								this.renderProgram.uniforms.topLeft[1] +
									this.$el.innerHeight() / l,
							]));
			...
			(e.fn.ripples = function (t) {
				...
				return this.each(function () {
					...
					(o || "string" != typeof t) &&
						(o
							? "string" == typeof t && u.prototype[t].apply(o, n)
							: i.data("ripples", (o = new u(this, r))));
				});
			}),
	...
	SYky: function (e, t, n) {
		!(function (e, t, n) {
			...
			t(document)
				.on(v.CLICK_DATA_API, g.DATA_TOGGLE_CARROT, function (e) {
					e.preventDefault();
					var n = e.target;
			...
			var b = "carousel",
				...
				S = { NEXT: "next", PREV: "prev", LEFT: "left", RIGHT: "right" },
				C = {
				...
				O = (function () {
					...
					return (
						...
						(n._slide = function (e, n) {
							...
							if (
								(e === S.NEXT
									? ((i = x.LEFT), (o = x.NEXT), (r = S.LEFT))
									: ((i = x.RIGHT), (o = x.PREV), (r = S.RIGHT)),
			...
			var I = "collapse",
				...
				M = (function () {
					...
					return (
						...
						(n.show = function () {
							...
							if (
								!(
									...
									t(this._element).hasClass(R.SHOW) ||
									(this._parent &&
										0 ===
											(n = [].slice
												...
												.filter(function (e) {
													return "string" == typeof o._config.parent
														...
														: e.classList.contains(R.COLLAPSE);
												})).length &&
										(n = null),
									n &&
								...
								if ((t(this._element).trigger(r), !r.isDefaultPrevented())) {
									...
									t(this._element)
										.removeClass(R.COLLAPSE)
										.addClass(R.COLLAPSING),
									...
									if (o > 0)
										for (var r = 0; r < o; r++) {
											...
											if (null !== a) {
												...
												l.hasClass(R.SHOW) ||
													t(s).addClass(R.COLLAPSED).attr("aria-expanded", !1);
											}
										}
						...
						(n._getConfig = function (e) {
							return (
								((e = s({}, N, e)).toggle = Boolean(e.toggle)),
						...
						(n._addAriaAndCollapsedClass = function (e, n) {
							...
							n.length &&
								t(n).toggleClass(R.COLLAPSED, !i).attr("aria-expanded", i);
						}),
					...
					return (
							...
							if (
								...
								if ((e._clearMenus(), !o)) {
									...
									if ((t(i).trigger(s), !s.isDefaultPrevented())) {
										if (!this._inNavbar) {
											...
											"parent" === this._config.reference
												...
												"scrollParent" !== this._config.boundary &&
													t(i).addClass(U.POSITION_STATIC),
												(this._popper = new n(
													a,
													this._menu,
										...
										"ontouchstart" in document.documentElement &&
											0 === t(i).closest(q.NAVBAR_NAV).length &&
						...
						(i._getPlacement = function () {
							...
							return (
								e.hasClass(U.DROPUP)
									? ((n = z.TOP),
									  t(this._menu).hasClass(U.MENURIGHT) && (n = z.TOPEND))
									: e.hasClass(U.DROPRIGHT)
									? (n = z.RIGHT)
									: e.hasClass(U.DROPLEFT)
									? (n = z.LEFT)
									: t(this._menu).hasClass(U.MENURIGHT) && (n = z.BOTTOMEND),
								n
							);
						}),
						...
						(e._jQueryInterface = function (n) {
							return this.each(function () {
								...
								if (
									(i || ((i = new e(this, o)), t(this).data("bs.dropdown", i)),
									"string" == typeof n)
								) {
									if (void 0 === i[n])
										throw new TypeError('No method named "' + n + '"');
									...
									? !(
											...
											(27 !== n.which &&
												((40 !== n.which && 38 !== n.which) ||
													t(n.target).closest(q.MENU).length))
									  )
									: W.test(n.which)) &&
								(n.preventDefault(),
								n.stopPropagation(),
			...
			t(document)
				.on(B.KEYDOWN_DATA_API, q.DATA_TOGGLE, G._dataApiKeydownHandler)
				.on(B.KEYDOWN_DATA_API, q.MENU, G._dataApiKeydownHandler)
				.on(B.CLICK_DATA_API + " " + B.KEYUP_DATA_API, G._clearMenus)
				.on(B.CLICK_DATA_API, q.DATA_TOGGLE, function (e) {
					e.preventDefault(),
						e.stopPropagation(),
					...
					return (
						...
						(n.show = function (e) {
							...
							if (!this._isShown && !this._isTransitioning) {
								t(this._element).hasClass(Z.FADE) &&
						...
						(n._showElement = function (e) {
							...
							(this._element.parentNode &&
								...
								t(this._dialog).hasClass(Z.SCROLLABLE)
									? (this._dialog.querySelector(ee.MODAL_BODY).scrollTop = 0)
									: (this._element.scrollTop = 0),
								i && c.reflow(this._element),
								t(this._element).addClass(Z.SHOW),
								this._config.focus && this._enforceFocus();
							var o = t.Event(J.SHOWN, { relatedTarget: e }),
								r = function () {
						...
						(n._setEscapeEvent = function () {
							...
							this._isShown && this._config.keyboard
								? t(this._element).on(J.KEYDOWN_DISMISS, function (t) {
						...
						(n._setResizeEvent = function () {
							var e = this;
							this._isShown
								? t(window).on(J.RESIZE, function (t) {
							...
							a.forEach(function (e) {
								(function (e, t) {
									...
									if (-1 !== t.indexOf(n))
										return (
											-1 === ne.indexOf(n) ||
											Boolean(e.nodeValue.match(oe) || e.nodeValue.match(re))
										);
									for (
					...
					return (
						...
						(i.setContent = function () {
							...
							this.setElementContent(
								t(e.querySelectorAll(ve.TOOLTIP_INNER)),
								this.getTitle()
							),
						...
						(i._enter = function (e, n) {
							...
							(n = n || t(e.currentTarget).data(i)) ||
								...
								e &&
									(n._activeTrigger[
										"focusin" === e.type ? ye.FOCUS : ye.HOVER
									] = !0),
								t(n.getTipElement()).hasClass(ge.SHOW) ||
								n._hoverState === he.SHOW
									? (n._hoverState = he.SHOW)
						...
						(i._leave = function (e, n) {
							...
							(n = n || t(e.currentTarget).data(i)) ||
								...
								e &&
									(n._activeTrigger[
										"focusout" === e.type ? ye.FOCUS : ye.HOVER
									] = !1),
			...
			var Te = "popover",
				...
				Se = s({}, be.DefaultType, { content: "(string|element|function)" }),
			...
			var Oe = "scrollspy",
				...
				He = { OFFSET: "offset", POSITION: "position" },
				je = (function () {
					function e(e, n) {
						var i = this;
						(this._element = e),
					...
					return (
						...
						(n._getConfig = function (e) {
							if (
								"string" !=
								typeof (e = s({}, De, "object" == typeof e && e ? e : {}))
									.target
							) {
								var n = t(e.target).attr("id");
								n || ((n = c.getUID(Oe)), t(e.target).attr("id", n)),
									(e.target = "#" + n);
							}
						...
						(n._activate = function (e) {
							...
							i.hasClass(Pe.DROPDOWN_ITEM)
								? (i
										.closest(Re.DROPDOWN)
										.find(Re.DROPDOWN_TOGGLE)
										.addClass(Pe.ACTIVE),
								  i.addClass(Pe.ACTIVE))
								: (i.addClass(Pe.ACTIVE),
								  i
						...
						(e._jQueryInterface = function (n) {
							return this.each(function () {
								var i = t(this).data("bs.scrollspy"),
									o = "object" == typeof n && n;
								if (
									(i || ((i = new e(this, o)), t(this).data("bs.scrollspy", i)),
									"string" == typeof n)
								) {
									if (void 0 === i[n])
										throw new TypeError('No method named "' + n + '"');
			...
			t(window).on(Le.LOAD_DATA_API, function () {
				for (
					var e = [].slice.call(document.querySelectorAll(Re.DATA_SPY)),
						n = e.length,
						i = n;
					i--;
						...
						(n.show = function () {
							...
							if (
								!(
									(this._element.parentNode &&
										this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
										t(this._element).hasClass(Fe.ACTIVE)) ||
									t(this._element).hasClass(Fe.DISABLED)
								)
							) {
								var n,
									i,
									o = t(this._element).closest(We.NAV_LIST_GROUP)[0],
								...
								var a = t.Event($e.HIDE, { relatedTarget: this._element }),
									l = t.Event($e.SHOW, { relatedTarget: i });
								if (
									(i && t(i).trigger(a),
									...
									var u = function () {
										var n = t.Event($e.HIDDEN, { relatedTarget: e._element }),
											o = t.Event($e.SHOWN, { relatedTarget: i });
							...
							var o = this,
								r =
									!n || ("UL" !== n.nodeName && "OL" !== n.nodeName)
										? t(n).children(We.ACTIVE)
										: t(n).find(We.ACTIVE_UL),
								s = r[0],
			...
			var Ue = t.fn.toast,
				...
				Ge = { DATA_DISMISS: '[data-dismiss="toast"]' },
				Ye = (function () {
					function e(e, t) {
						(this._element = e),
							(this._config = this._getConfig(t)),
					...
					return (
						...
						(n.hide = function (e) {
							...
							this._element.classList.contains(ze.SHOW) &&
								(t(this._element).trigger(qe.HIDE),
								e
									? this._close()
						...
						(e._jQueryInterface = function (n) {
							return this.each(function () {
								var i = t(this),
									...
									r = "object" == typeof n && n;
								if (
									(o || ((o = new e(this, r)), i.data("bs.toast", o)),
									"string" == typeof n)
								) {
									if (void 0 === o[n])
										throw new TypeError('No method named "' + n + '"');
				...
				e(document).ready(function () {
					function t() {
						var t = e(".calculator-invest").val(),
							...
							n = e(".calculator-profit-mq").val();
							n = e(".calculator-profit-sni1").val();
							n = e(".calculator-profit-sni2").val();
						if (!isNaN(t) && !isNaN(n)) {
							var i = t * n;
							e(".calculator-result-daily").text(i),
								e(".calculator-result-weekly").text(i),
								e(".calculator-result-monthly").text(i);
						}
					}
					function n() {
					...
					e('#primary-menu li a[href*="#"]')
						...
						e(".choose-section-carousel").slick({
							...
							arrows: !0,
							prevArrow:
								"<button type='button' class='slick-prev pull-left'><i class=\"icofont-thin-left\"  aria-hidden='true'></i></button>",
							nextArrow:
								"<button type='button' class='slick-next pull-right'><i class=\"icofont-thin-right\"  aria-hidden='true'></i></button>",
							dots: !0,
						...
						e(".testimonial-carousel").slick({
							...
							arrows: !0,
							prevArrow:
								"<button type='button' class='slick-prev pull-left'><i class=\"icofont-thin-double-left\"  aria-hidden='true'></i></button>",
							nextArrow:
								"<button type='button' class='slick-next pull-right'><i class=\"icofont-thin-double-right\"  aria-hidden='true'></i></button>",
							responsive: [
								{
									breakpoint: 600,
						...
						(function () {
							new JParticles.particle("#particles .particles", { num: 100 });
						})(),
