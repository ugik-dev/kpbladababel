...
class HargaMWPModel extends CI_Model {
  ...
  public function getStandarMutu(){
    ...
    $this->db->insert('harga_mwp', DataStructure::slice($data, ['tanggal_berlaku', 'harga_mwp1_petani', 'harga_mwp1_fob', 'harga_mwp2_petani', 'harga_mwp2_fob', 'harga_asta_petani', 'harga_asta_fob', 'harga_esa_petani', 'harga_esa_fob', 'harga_ipc_petani', 'harga_ipc_fob', 'harga_sni1_petani', 'harga_sni1_fob', 'harga_iso_petani', 'harga_iso_fob']));
    ...
    $this->db->update('harga_mwp', DataStructure::slice($data, ['tanggal_berlaku', 'harga_mwp1_petani', 'harga_mwp1_fob', 'harga_mwp2_petani', 'harga_mwp2_fob', 'harga_asta_petani', 'harga_asta_fob', 'harga_esa_petani', 'harga_esa_fob', 'harga_ipc_petani', 'harga_ipc_fob', 'harga_sni1_petani', 'harga_sni1_fob', 'harga_iso_petani', 'harga_iso_fob'], TRUE));
