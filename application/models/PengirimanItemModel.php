...
class PengirimanItemModel extends CI_Model {
  ...
  public function getAll($filter = []){
    ...
    $this->db->insert('pengiriman_item', DataStructure::slice($data, ['id_pengiriman', 'netto', 'gross', 'id_jenis_mutu', 'nama_importir', 'city', 'province', 'id_negara', 'id_port_of_origin', 'port_of_destination', 'id_jenis_pengemasan', 'tanggal_pengiriman', 'shipping_mark', 'keterangan_marking', 'nomor_kontrak']));
    ...
    $this->db->update('pengiriman_item', DataStructure::slice($data, ['netto', 'gross', 'id_jenis_mutu', 'nama_importir', 'city', 'province', 'id_negara', 'id_port_of_origin', 'port_of_destination', 'id_jenis_pengemasan', 'tanggal_pengiriman', 'shipping_mark', 'keterangan_marking', 'nomor_kontrak'], TRUE));
