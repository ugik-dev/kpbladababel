<div class="tabs-container">
  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" id="dokumen_perusahaan" class="tab-pane"><div class="panel-body"></div></div>
    <div role="tabpanel" id="product" class="tab-pane"><div class="panel-body"></div></div>
    <div role="tabpanel" id="pengiriman" class="tab-pane"><div class="panel-body"></div></div>
  </div>
</div>
<style>
...
$(document).ready(function() {
  ...
  getInfo();
  function getInfo(){
    swal({title: 'Loading Informasi Perusahaan...', allowOutsideClick: false});
    swal.showLoading();
    return $.ajax({
