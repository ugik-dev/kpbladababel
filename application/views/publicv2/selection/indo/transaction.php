    ...
    <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-7 col-md-11">
                ...
                <!-- <li class="nav-item transaction-nav-item filter_harga" data-filter="mingguan">
                            <a class="nav-link transaction-nav-link" id="transaction-pills-withdrawal-tab" data-toggle="pill" href="#" role="tab" aria-controls="pills-withdrawal" aria-selected="false">
                                <span class="d-flex align-items-center"><i class="ren-investo d-flex align-items-center"></i>Mingguan<br /></span>
                            </a>
                        </li>
                        <li class="nav-item transaction-nav-item filter_harga" data-filter="bulanan">
                            <a class="nav-link transaction-nav-link" id="transaction-pills-investing-tab" data-toggle="pill" href="#" role="tab" aria-controls="pills-invest" aria-selected="false">
                                <span class="d-flex align-items-center"><i class="ren-people3 d-flex align-items-center"></i>Bulanan<br /></span>
                            </a>
                        </li> -->
                </ul>
            </div>
