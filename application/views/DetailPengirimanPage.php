<div class="tabs-container">
  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" id="dokumen" class="tab-pane"><div class="panel-body"></div></div>
  </div>
</div>
<style>
...
$(document).ready(function() {
  ...
  getInfo();
  function getInfo(){
    swal({title: 'Loading Informasi Pengiriman...', allowOutsideClick: false});
    swal.showLoading();
    return $.ajax({
      ...
      success: function (data){
        ...
        dataInfo = json['data'];
        renderBreadcrumb([[`<?=site_url('PerusahaanController/detail')?>?id_perusahaan=${dataInfo['id_perusahaan']}`, dataInfo['nama_perusahaan']], [null, `Pengiriman ${dataInfo['nama_pengiriman']}`]]);
        init();
      },
      error: function(e) {}
    });
  ...
  function init(){
    $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
      ...
      if(user_action){
        var params = new URLSearchParams([['id_pengiriman', id_pengiriman], ['tab', target]]);
