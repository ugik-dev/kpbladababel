...
$(document).ready(function() {
  ...
  function getAllRole(){
    return $.ajax({
      url: `<?php echo site_url('ParameterController/getAllRole/')?>`, 'type': 'POST',
      data: {},
  ...
  function renderRoleSelectionFilter(data){
    ...
    toolbar.id_role.append($('<option>', { value: "", text: "-- Semua Role --"}));
  ...
  function renderRoleSelectionAdd(data){
    ...
    UserModal.id_role.append($('<option>', { value: "", text: "-- Pilih Role --"}));
    Object.values(data).forEach((d) => {
  ...
  function getAllUser(){
    ...
    swal.showLoading();
    return $.ajax({
      url: `<?php echo site_url('UserController/getAllUser/')?>`, 'type': 'POST',
